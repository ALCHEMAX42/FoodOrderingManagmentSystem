	...
	<header>
		<div class="dropdown">
			...
			<ul class="dropdown-menu">
				<li>
					<a class="dropdown-item" href="userLoggedIn.php">Home</a>
				</li>
				...
				<div class="card">
					...
					?>
							<div class="form-row">
								...
								<div class="form-group col-sm-3">
									<!-- <label>Cuisine Image</label> -->
									<img src="<?php echo $row['image']; ?>" style="height: 120px;width:120px;border-radius:20px;border: 2px solid #2d2d2d;">
								</div>
								<div class="form-group col-sm-2">
									<!-- <label>Count</label> -->
