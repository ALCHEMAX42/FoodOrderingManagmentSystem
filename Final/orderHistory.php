		...
		if (mysqli_num_rows($res) > 0) {
			while ($rows = mysqli_fetch_array($res)) {
				...
				<div class="card" style="border-radius:20px;padding-right:240px;margin-top:5px !important;width: 50%;">
					...
					<h6><?php echo "Ordered on: " . $time; ?></h6>
					<?php
					...
					echo "Total=" . $cost . " <br><span style='display:block;font-weight:700;top:20px;color:green;'>Status=" . $status . "</span>" ?>
				</div><?php
					}
